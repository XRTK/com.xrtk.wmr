...
namespace XRTK.WindowsMixedReality.Utilities
{
    ...
    public static class WindowsApiChecker
    {
        ...
        {
#if WINDOWS_UWP
            UniversalApiContractV8_IsAvailable = Windows.Foundation.Metadata.ApiInformation.IsApiContractPresent(nameof(Windows.Foundation.UniversalApiContract), 8);
            UniversalApiContractV7_IsAvailable = Windows.Foundation.Metadata.ApiInformation.IsApiContractPresent(nameof(Windows.Foundation.UniversalApiContract), 7);
            UniversalApiContractV6_IsAvailable = Windows.Foundation.Metadata.ApiInformation.IsApiContractPresent(nameof(Windows.Foundation.UniversalApiContract), 6);
            UniversalApiContractV5_IsAvailable = Windows.Foundation.Metadata.ApiInformation.IsApiContractPresent(nameof(Windows.Foundation.UniversalApiContract), 5);
            UniversalApiContractV4_IsAvailable = Windows.Foundation.Metadata.ApiInformation.IsApiContractPresent(nameof(Windows.Foundation.UniversalApiContract), 4);
            UniversalApiContractV3_IsAvailable = Windows.Foundation.Metadata.ApiInformation.IsApiContractPresent(nameof(Windows.Foundation.UniversalApiContract), 3);
#else
